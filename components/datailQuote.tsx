...
{/* 
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            <button type="button" className="px-4 py-2 text-cyan-700 border rounded-lg hover:bg-orange-500 hover:text-white">Less than ₹1500</button>
            <button type="button" className="px-4 py-2 text-cyan-700 border rounded-lg hover:bg-orange-500 hover:text-white">₹1500 – ₹2500</button>
            <button type="button" className="px-4 py-2 text-cyan-700 border rounded-lg hover:bg-orange-500 hover:text-white">₹2500 – ₹4000</button>
            <button type="button" className="px-4 py-2 text-cyan-700 border rounded-lg hover:bg-orange-500 hover:text-white">₹4000 – ₹8000</button>
            <button type="button" className="px-4 py-2 text-cyan-700 border rounded-lg hover:bg-orange-500 hover:text-white">More than ₹8000</button>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2 text-sm">
          ...
          <span className="text-orange-400">I agree to SolarSquare's <a href="#" className="text-cyan-500">terms of service</a> & <a href="#" className="text-cyan-500">privacy policy</a></span>
        </div>
