        ...
        <form className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <p className="text-xs text-orange-400">
              I agree to sarvatra's <a href="#" className="underline text-cyan-500">terms of service</a> &{" "}
      ...
      {activeTab === "housing" && (
        <form className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            <input type="checkbox" required />
            <p className="text-xs text-orange-400">
              I agree to sarvatra's <a href="#" className="text-cyan-500 underline">terms of service</a> &{" "}
              <a href="#" className="underline">privacy policy</a>
            </p>
          </div>
          <button type="submit" className="w-full bg-orange-400 hover:bg-orange-700 text-white py-2 rounded-lg">Submit Details</button>
